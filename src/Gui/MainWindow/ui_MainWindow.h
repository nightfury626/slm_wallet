...
public:
    ...
    QAction *m_aboutSiliconLumenAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/siliconlumen"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutSiliconLumenAction = new QAction(MainWindow);
        m_aboutSiliconLumenAction->setObjectName(QStringLiteral("m_aboutSiliconLumenAction"));
        m_aboutSiliconLumenAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutSiliconLumenAction);
        ...
        QObject::connect(m_aboutSiliconLumenAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutSiliconLumenAction->setText(QApplication::translate("MainWindow", "About SiliconLumen", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND SILICONLUMEN", Q_NULLPTR));
