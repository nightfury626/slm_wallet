...
const char COMMUNITY_FORUM_URL[] = "https://siliconlumen.herokuapp.com";
const char REPORT_ISSUE_URL[] = "https://siliconlumen.org/#contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("SiliconLumen Wallet %1").arg(Settings::instance().getVersion()));
